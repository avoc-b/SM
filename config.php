...
define('DEBUG',0);                                 //1 -ведение логов всегда, 0 -только на локальной машине
define('PLUGIN_WIKI',0);                           //1 -отображать wiki всегда, 0 -только на локальной машине или при отладке
...
define('SERVER_ADDR','10.51.21.23');
