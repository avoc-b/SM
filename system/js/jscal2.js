...
Calendar = function () {
    function t(e) {
        var n, a, s
            ...
            this.handlers = {}, n = this,
            a = new Date,
            e.min = k(e.min),
            e.max = k(e.max),
            e.date === !0 && (e.date = a), e.time === !0 && (e.time = a.getHours() * 100 + Math.floor(a.getMinutes() / e.minuteStep) * e.minuteStep), this.date = k(e.date),
            this.time = e.time,
            this.fdow = e.fdow,
            q("onChange onSelect onTimeChange onFocus onBlur onClose".split(/\s+/), function (t) {
                var a = e[t]
                a instanceof Array || (a = [a]),
                    n.handlers[t] = a
            }), this.selection = new t.Selection(e.selection, e.selectionType, C, this),
            s = l(this),
            e.cont && J(e.cont).appendChild(s), e.trigger && this.manageFields(e.trigger, e.inputField, e.dateFormat)
    }
    ...
    function n(t, e, n) {
        ...
        for (e = e || t.date, n = n || t.fdow, e = new Date(e.getFullYear(), e.getMonth(), e.getDate(), 12, 0, 0, 0), a = e.getMonth(), s = [], i = 0, r = t.args.weekNumbers, e.setDate(1), o = (e.getDay() - n) % 7, 0 > o && (o += 7), e.setDate(0 - o), e.setDate(e.getDate() + 1), l = new Date, c = l.getDate(), h = l.getMonth(), u = l.getFullYear(), s[i++] = "<table class='DynarchCalendar-bodyTable'" + Q + ">", d = 0; 6 > d; ++d) {
            for (s[i++] = "<tr class='DynarchCalendar-week",
    ...
    function a(t) {
        var n = ["<table class='DynarchCalendar-topCont'", Q, "><tr><td>", "<div class='DynarchCalendar'>", le ? "<a class='DynarchCalendar-focusLink' href='#'></a>" : "<button class='DynarchCalendar-focusLink'></button>", "<div class='DynarchCalendar-topBar'>", "<div dyc-type='nav' dyc-btn='-Y' dyc-cls='hover-navBtn,pressed-navBtn' ",
            "class='DynarchCalendar-navBtn DynarchCalendar-prevYear'><div></div></div>", "<div dyc-type='nav' dyc-btn='+Y' dyc-cls='hover-navBtn,pressed-navBtn' ", "class='DynarchCalendar-navBtn DynarchCalendar-nextYear'><div></div></div>", "<div dyc-type='nav' dyc-btn='-M' dyc-cls='hover-navBtn,pressed-navBtn' ", "class='DynarchCalendar-navBtn DynarchCalendar-prevMonth'><div></div></div>",
            "<div dyc-type='nav' dyc-btn='+M' dyc-cls='hover-navBtn,pressed-navBtn' ", "class='DynarchCalendar-navBtn DynarchCalendar-nextMonth'><div></div></div>", "<table class='DynarchCalendar-titleCont'", Q, "><tr><td>", "<div dyc-type='title' dyc-btn='menu' dyc-cls='hover-title,pressed-title' class='DynarchCalendar-title'>", s(t), "</div></td></tr></table>", "<div class='DynarchCalendar-dayNames'>",
            e(t), "</div>", "</div>", "<div class='DynarchCalendar-body'></div>"
        ]
    ...
    function i(t) {
        for (var e, n = ["<table height='100%'", Q, "><tr><td>", "<table style='margin-top: 1.5em'", Q, ">", "<tr><td colspan='3'><input dyc-btn='year' class='DynarchCalendar-menu-year' size='6' value='", t.date.getFullYear(), "' /></td></tr>", "<tr><td><div dyc-type='menubtn' dyc-cls='hover-navBtn,pressed-navBtn' dyc-btn='today'>", _("goToday"), "</div></td></tr>",
                "</table>", "<p class='DynarchCalendar-menu-sep'>&nbsp;</p>", "<table class='DynarchCalendar-menu-mtable'", Q, ">"
            ], a = _("smn"), s = 0, i = n.length; 12 > s;) {
            for (n[i++] = "<tr>", e = 4; --e > 0;) n[i++] = "<td><div dyc-type='menubtn' dyc-cls='hover-navBtn,pressed-navBtn' dyc-btn='m" + s + "' class='DynarchCalendar-menu-month'>" + a[s++] + "</div></td>"
            n[i++] = "</tr>"
        }
    ...
    function r(t, e) {
        e.push("<table class='DynarchCalendar-time'" + Q + "><tr>", "<td rowspan='2'><div dyc-type='time-hour' dyc-cls='hover-time,pressed-time' class='DynarchCalendar-time-hour'></div></td>", "<td dyc-type='time-hour+' dyc-cls='hover-time,pressed-time' class='DynarchCalendar-time-up'></td>",
            "<td rowspan='2' class='DynarchCalendar-time-sep'></td>", "<td rowspan='2'><div dyc-type='time-min' dyc-cls='hover-time,pressed-time' class='DynarchCalendar-time-minute'></div></td>", "<td dyc-type='time-min+' dyc-cls='hover-time,pressed-time' class='DynarchCalendar-time-up'></td>"), t.args.showTime == 12 && e.push("<td rowspan='2' class='DynarchCalendar-time-sep'></td>",
            "<td rowspan='2'><div class='DynarchCalendar-time-am' dyc-type='time-am' dyc-cls='hover-time,pressed-time'></div></td>"), e.push("</tr><tr>", "<td dyc-type='time-hour-' dyc-cls='hover-time,pressed-time' class='DynarchCalendar-time-down'></td>", "<td dyc-type='time-min-' dyc-cls='hover-time,pressed-time' class='DynarchCalendar-time-down'></td>", "</tr></table>")
    }
    ...
    function l(t) {
        ...
        return t.args.noScroll || (s[he ? "DOMMouseScroll" : "mousewheel"] = O(b, t)), le && (s.dblclick = s.mousedown, s.keydown = s.keypress), e.innerHTML = a(t), W(e.firstChild, function (t) {
            var e = Z[t.className]
            e && (n[e] = t),
                le && t.setAttribute("unselectable", "on")
        }), B(n.main, s), B([n.focusLink, n.yearInput], t._focusEvents = {
            focus: O(c, t),
            blur: O(u, t)
        }), t.moveTo(t.date, !1), t.setTime(null, !0), n.topCont
    }

    function c() {
        this._bluringTimeout && clearTimeout(this._bluringTimeout), this.focused = !0, P(this.els.main, "DynarchCalendar-focused"), this.callHooks("onFocus", this)
    }

    function h() {
        this.focused = !1, Y(this.els.main, "DynarchCalendar-focused"),
        this._menuVisible && y(this, !1), this.args.cont || this.hide(), this.callHooks("onBlur", this)
    }
    ...
    function f(t, e, n) {
        ...
        var a
        if (0 != e) switch (a = new Date(t.date), a.setDate(1), e) {
        case "-Y":
        case -2:
    ...
    function y(t, e) {
        var n, a
            t._menuVisible = e,
            R(e, t.els.title, "DynarchCalendar-pressed-title"), n = t.els.menu,
            ce && (n.style.height = t.els.main.offsetHeight + "px"), t.args.animation ? (t._menuAnim && t._menuAnim.stop(), a = t.els.main.offsetHeight, ce && (n.style.width = t.els.topBar.offsetWidth + "px"), e && (n.firstChild.style.marginTop = -a + "px", t.args.opacity > 0 && $(n, 0), j(n, !0)), t._menuAnim = K({
                onUpdate: function (s, i) {
                    n.firstChild.style.marginTop = i(ae.accel_b(s), -a, 0, !e) + "px",
                    t.args.opacity > 0 && $(n, i(ae.accel_b(s), 0, .85, !e))
                },
                onStop: function () {
                    t.args.opacity > 0 && $(n, .85), n.firstChild.style.marginTop = "", t._menuAnim = null, e || (j(n, !1), t.focused && t.focus())
                }
    ...
    function m(e, n) {
        var a, s, i, r, o, l, c, h, u
            n = n || window.event,
            a = g(n),
            a && !a.getAttribute("disabled") && (i = a.getAttribute("dyc-btn"), r = a.getAttribute("dyc-type"), o = a.getAttribute("dyc-date"), l = this.selection, c = {
                mouseover: N,
                mousemove: N,
                mouseup: function () {
                    var t = a.getAttribute("dyc-cls")
                    t && Y(a, v(t, 1)),
                        clearTimeout(s), F(document, c, !0), c = null
                }
            }, e ? (setTimeout(O(this.focus, this), 1), h = a.getAttribute("dyc-cls"), h && P(a, v(h, 1)), "menu" == i ? this.toggleMenu() : a && /^[+-][MY]$/.test(i) ? f(this, i) ? (u = O(function () {
                f(this, i, !0) ? s = setTimeout(u, 40) : (c.mouseup(), f(this, i))
            }, this), s = setTimeout(u, 350), B(document, c, !0)) : c.mouseup() : "year" == i ? (this.els.yearInput.focus(),
                this.els.yearInput.select()) : "time-am" == r ? B(document, c, !0) : /^time/.test(r) ? (u = O(function (t) {
                d.call(this, t), s = setTimeout(u, 100)
            }, this, r), d.call(this, r), s = setTimeout(u, 350), B(document, c, !0)) : (o && l.type && (l.type == t.SEL_MULTIPLE ? n.shiftKey && this._selRangeStart ? l.selectRange(this._selRangeStart, o) : (n.ctrlKey || l.isSelected(o) || !this.args.multiCtrl || l.clear(!0), l.set(o, !0), this._selRangeStart = o) : (l.set(o), this.moveTo(A(o), 2)),
                a = this._getDateDiv(o), D.call(this, !0, {
                    target: a
                })), B(document, c, !0)), le && c && /dbl/i.test(n.type) && c.mouseup(), this.args.fixed || !/^(DynarchCalendar-(topBar|bottomBar|weekend|weekNumber|menu(-sep)?))?$/.test(a.className) || this.args.cont || (c.mousemove = O(p, this), this._mouseDiff = z(n, G(this.els.topCont)), B(document, c, !0))) : "today" == i ? (this._menuVisible || l.type != t.SEL_SINGLE || l.set(new Date), this.moveTo(new Date, !0),
                y(this, !1)) : /^m([0-9]+)/.test(i) ? (o = new Date(this.date), o.setDate(1), o.setMonth(RegExp.$1), o.setFullYear(this._getInputYear()), this.moveTo(o, !0), y(this, !1)) : "time-am" == r && this.setHours(this.getHours() + 12), le || N(n))
    }
    ...
    function D(t, e) {
        var n, a, s
            e = e || window.event,
            n = g(e),
            n && (a = n.getAttribute("dyc-type"), a && !n.getAttribute("disabled") && (t && this._bodyAnim && "date" == a || (s = n.getAttribute("dyc-cls"), s = s ? v(s, 0) : "DynarchCalendar-hover-" + a, ("date" != a || this.selection.type) && R(t, n, s), "date" == a && (R(t, n.parentNode.parentNode, "DynarchCalendar-hover-week"), this._showTooltip(n.getAttribute("dyc-date"))), /^time-hour/.test(a) && R(t, this.els.timeHour, "DynarchCalendar-hover-time"),
                /^time-min/.test(a) && R(t, this.els.timeMinute, "DynarchCalendar-hover-time"), Y(this._getDateDiv(this._lastHoverDate), "DynarchCalendar-hover-date"), this._lastHoverDate = null))), t || this._showTooltip()
    }

    function b(t) {
        var e, n, a, s
        if (t = t || window.event, e = g(t))
            if (n = e.getAttribute("dyc-btn"), a = e.getAttribute("dyc-type"), s = t.wheelDelta ? t.wheelDelta / 120 : -t.detail / 3, s = 0 > s ? -1 : s > 0 ? 1 : 0, this.args.reverseWheel && (s = -s), /^(time-(hour|min))/.test(a)) {
                switch (RegExp.$1) {
                case "time-hour":
    ...
    function C() {
        var t, e, n
            this.refresh(), t = this.inputField,
            e = this.selection,
            t && (n = e.print(this.dateFormat), /input|textarea/i.test(t.tagName) ? t.value = n : t.innerHTML = n), this.callHooks("onSelect", this, e)
    }

    function w(e) {
        var n, a, s, i, r, o, l, c, h, u, d, m, p
        if (!this._menuAnim) {
            if (e = e || window.event, n = e.target || e.srcElement, a = n.getAttribute("dyc-btn"), s = e.keyCode, i = e.charCode || s, r = ee[s], "year" == a && 13 == s) return o = new Date(this.date), o.setDate(1), o.setFullYear(this._getInputYear()), this.moveTo(o, !0), y(this, !1), N(e)
            if (this._menuVisible) {
                if (27 == s) return y(this, !1), N(e)
            } else {
                if (e.ctrlKey || (r = null), null != r || e.ctrlKey || (r = ne[s]), 36 == s && (r = 0), null != r) return f(this, r), N(e)
                ...
                if (s >= 37 && 40 >= s) {
                    if (o = this._lastHoverDate, o || c.isEmpty() || (o = 39 > s ? c.getFirstDate() : c.getLastDate(), (o < this._firstDateVisible || o > this._lastDateVisible) && (o = null)), o) {
                        ...
                        o = L(o), (o < this._firstDateVisible || o > this._lastDateVisible) && this.moveTo(o)
    ...
    function M(t, e) {
        return t.replace(/\$\{([^:\}]+)(:[^\}]+)?\}/g, function (t, n, a) {
            var s, i = e[n]
            return a && (s = a.substr(1).split(/\s*\|\s*/), i = (i < s.length ? s[i] : s[s.length - 1]).replace(/##?/g, function (t) {
                return t.length == 2 ? "#" : i
            })), i
        })
    }
    ...
    function L(t) {
        return t instanceof Date ? 1e4 * t.getFullYear() + 100 * (t.getMonth() + 1) + t.getDate() : "string" == typeof t ? parseInt(t, 10) : t
    }
    ...
    function N(t) {
        return t = t || window.event, le ? (t.cancelBubble = !0, t.returnValue = !1) : (t.preventDefault(), t.stopPropagation()), !1
    }

    function Y(t, e, n) {
        if (t) {
            var a, s = t.className.replace(/^\s+|\s+$/, "").split(/\x20/),
                i = []
    ...
    function $(t, e) {
        return "" === e ? le ? t.style.filter = "" : t.style.opacity = "" : null != e ? le ? t.style.filter = "alpha(opacity=" + 100 * e + ")" : t.style.opacity = e : le ? /alpha\(opacity=([0-9.])+\)/.test(t.style.opacity) && (e = parseFloat(RegExp.$1) / 100) : e = parseFloat(t.style.opacity), e
    }
    ...
    function G(t) {
        var e, n, a
        if (t.getBoundingClientRect) return e = t.getBoundingClientRect(), {
    ...
    function J(t) {        
        ...
        if(e) { console.log(e); return "string" == typeof t && (t = e), t}
        else {
            //console.log(document.getElementsByClassName(t)[0]);
            //t = t.substring(1, t.length);
            var arr = document.getElementsByClassName(t);
            for(ii=0; ii<arr.length; ++ii)                
                if(!arr[ii].getAttribute('cln')) {
                    return "string" == typeof t && (t = arr[ii]), t
                } 
            return t
        }
        
    }
    var Q, Z, te, ee, ne, ae, se, ie = navigator.userAgent,
        re = /opera/i.test(ie),
        ...
        ue = t.prototype,
        de = t.I18N = {}
    return t.SEL_NONE = 0, t.SEL_SINGLE = 1, t.SEL_MULTIPLE = 2, t.SEL_WEEK = 3, t.dateToInt = L, t.intToDate = A, t.printDate = S, t.formatString = M, t.i18n = _, t.LANG = function (t, e, n) {
        de.__ = de[t] = {
            name: e,
            data: n
        }
        ...
        var a, s, i, r, o, l, c, h, u, d, f, y, m, p, g, v, D = this
        return t = k(t), s = H(t, D.date, !0), i = D.args, r = i.min && H(t, i.min), o = i.max && H(t, i.max), i.animation || (e = !1), R(null != r && 1 >= r, [D.els.navPrevMonth, D.els.navPrevYear], "DynarchCalendar-navDisabled"), R(null != o && o >= -1, [D.els.navNextMonth, D.els.navNextYear], "DynarchCalendar-navDisabled"), -1 > r && (t = i.min, a = 1, s = 0), o > 1 && (t = i.max, a = 2, s = 0), D.date = t, D.refresh( !! e), D.callHooks("onChange", D, t, e), !e || 0 == s && 2 == e || (D._bodyAnim && D._bodyAnim.stop(), l = D.els.body, c = V("div", "DynarchCalendar-animBody-" + te[s], l),
            h = l.firstChild, $(h) || .7, u = a ? ae.brakes : 0 == s ? ae.shake : ae.accel_ab2, d = s * s > 4, f = d ? h.offsetTop : h.offsetLeft, y = c.style, m = d ? l.offsetHeight : l.offsetWidth, 0 > s ? m += f : s > 0 ? m = f - m : (m = Math.round(m / 7), 2 == a && (m = -m)), a || 0 == s || (p = c.cloneNode(!0), g = p.style, v = 2 * m, p.appendChild(h.cloneNode(!0)), g[d ? "marginTop" : "marginLeft"] = m + "px", l.appendChild(p)), h.style.visibility = "hidden", c.innerHTML = n(D), D._bodyAnim = K({
            ...
            })), D._lastHoverDate = null, r >= -1 && 1 >= o
    }, ue.isDisabled = function (t) {
        var e = this.args
        return e.min && H(t, e.min) < 0 || e.max && H(t, e.max) > 0 || e.disabled(t)
        ...
        var t = this,
            ...
            n.bottomBar && (n.bottomBar.innerHTML = o(t)), W(n.topCont, function (e) {
                var a = Z[e.className]
                a && (n[a] = e),
                    e.className == "DynarchCalendar-menu-year" ? (B(e, t._focusEvents), n.yearInput = e) : le && e.setAttribute("unselectable", "on")
            }), t.setTime(null, !0)
        ...
        var a = this.els.topCont,
            ...
            o.zIndex = 1e4,
            o.display = "",
            n && (i.style.marginTop = -r + "px", this.args.opacity > 1 && $(a, 0), this._showAnim = K({
                onUpdate: function (t, e) {
                    i.style.marginTop = -e(ae.accel_b(t), r, 0) + "px", s.args.opacity > 1 && $(a, t)
                },
                onStop: function () {
        ...
        var t = this.els.topCont,
            ...
            a = n.offsetHeight,
            s = G(t).y
            this.args.animation ? (this._showAnim && this._showAnim.stop(), this._showAnim = K({
                onUpdate: function (i, r) {
                    e.args.opacity > 1 && $(t, 1 - i), n.style.marginTop = -r(ae.accel_b(i), 0, a) + "px", t.style.top = r(ae.accel_ab(i), s, s - 10) + "px"
                },
                onStop: function () {
                    t.style.display = "none", n.style.marginTop = "", e.args.opacity > 1 && $(t, ""), e._showAnim = null
                }
        ...
        var a, s, i, r, o, l
            t = J(t),
            e || (e = this.args.align), e = e.split(/\x2f/),
            s = G(t),
            i = this.els.topCont,
            r = i.style,
            o = X(),
            r.visibility = "hidden",
            r.display = "",
            this.showAt(0, 0), document.body.appendChild(i), a = {
                x: i.offsetWidth,
                y: i.offsetHeight
            }, l = s,
            l = n(e[0]),
            l.y < o.y && (l.y = s.y, l = n(e[1])), l.x + a.x > o.x + o.w && (l.x = s.x, l = n(e[2])), l.y + a.y > o.y + o.h && (l.y = s.y, l = n(e[3])), l.x < o.x && (l.x = s.x, l = n(e[4])), this.showAt(l.x, l.y, !0), r.visibility = "",
            this.focus()
        ...
        var s, i, r, o, l = this
            ...
            l.inputField = n,
            l.dateFormat = a,
            l.selection.type == t.SEL_SINGLE && (s = /input|textarea/i.test(n.tagName) ? n.value : n.innerText || n.textContent, s && (i = /(^|[^%])%[bBmo]/.exec(a), r = /(^|[^%])%[de]/.exec(a), i && r && (o = i.index < r.index), s = Calendar.parseDate(s, o), s && (l.selection.set(s, !1, !0), l.args.showTime && (l.setHours(s.getHours()), l.setMinutes(s.getMinutes())), l.moveTo(s)))), l.popup(e)
    }, ue.manageFields = function (t, e, n) {
        var a = this        
        e = J(e),
            t = J(t),
            /^button$/i.test(t.tagName) && t.setAttribute("type", "button"), B(t, "click", function (s) {
                return a.popupForField(t, e, n), N(s)
            })
    }, ue.callHooks = function (t) {
        for (var e = U(arguments, 1), n = this.handlers[t], a = 0; a < n.length; ++a) n[a].apply(this, e)
    }, ue.addEventListener = function (t, e) {
        this.handlers[t].push(e)
    }, ue.removeEventListener = function (t, e) {
        for (var n = this.handlers[t], a = n.length; --a >= 0;) n[a] === e && n.splice(a, 1)
    }, ue.getTime = function () {
        return this.time
    ...
    ue.getHours = function () {
        ...
        0 > t && (t += 60), t = Math.floor(t / this.args.minuteStep) * this.args.minuteStep, this.setTime(100 * this.getHours() + t % 60)
    }, ue._getInputYear = function () {
        var t = parseInt(this.els.yearInput.value, 10)
        return isNaN(t) && (t = this.date.getFullYear()),
            t
    }, ue._showTooltip = function (t) {
        var e, n = "",
            a = this.els.tooltip
            t && (t = A(t), e = this.args.dateInfo(t), e && e.tooltip && (n = "<div class='DynarchCalendar-tooltipCont'>" + S(t, e.tooltip) + "</div>")),
            a.innerHTML = n
    }, Q = " align='center' cellspacing='0' cellpadding='0'", Z = {
        ...
        this.type = e, this.sel = t instanceof Array ? t : [t], this.onChange = O(n, a), this.cal = a
    }).prototype = {
        get: function () {
        ...
        set: function (e, n, a) {
            ...
            e instanceof Array ? (this.sel = e, this.normalize(), a || this.onChange(this)) : (e = L(e), s || !this.isSelected(e) ? (s ? this.sel = [e] : this.sel.splice(this.findInsertPos(e), 0, e), this.normalize(), a || this.onChange(this)) : n && this.unselect(e, a))
        },
        reset: function () {
            this.sel = [], this.set.apply(this, arguments)
        },
        countDays: function () {
            for (var t, e, n, a = 0, s = this.sel, i = s.length; --i >= 0;) t = s[i], t instanceof Array && (e = A(t[0]), n = A(t[1]), a += Math.round(Math.abs(n.getTime() - e.getTime()) / 864e5)), ++a
            return a
        },
        ...
        normalize: function () {
            var t, e, n, a, s, i, r
            for (this.sel = this.sel.sort(function (t, e) {
                return t instanceof Array && (t = t[0]), e instanceof Array && (e = e[0]), t - e
            }), n = this.sel, a = n.length; --a >= 0;) {
                ...
                e && (s = e, i = t instanceof Array ? t[1] : t, i = A(i), i.setDate(i.getDate() + 1), i = L(i), s > i || (r = n[a + 1], t instanceof Array && r instanceof Array ? (t[1] = r[1], n.splice(a + 1, 1)) : t instanceof Array ? (t[1] = e, n.splice(a + 1, 1)) : r instanceof Array ? (r[0] = t, n.splice(a, 1)) : (n[a] = [t, r], n.splice(a + 1, 1)))),
                e = t instanceof Array ? t[0] : t
            }
        },
        findInsertPos: function (t) {
            for (var e, n = this.sel, a = n.length; --a >= 0 && (e = n[a], e instanceof Array && (e = e[0]), t < e););
            return a + 1
        },
        clear: function (t) {
        ...
        selectRange: function (e, n) {
            ...
            try {
                q(new t.Selection([
                    [e, n]
                ], t.SEL_MULTIPLE, se).getDates(), O(function (t) {
                    if (this.isDisabled(t)) throw s instanceof Function && s(t, this), "OUT"
                }, this.cal)), this._do_selectRange(e, n)
            } catch (i) {}
        },
        ...
        for (e = e.replace(/^\s+/, "").replace(/\s+$/, ""), a = a || new Date, s = null, i = null, r = null, o = null, l = null, c = null, h = e.match(/([0-9]{1,2}):([0-9]{1,2})(:[0-9]{1,2})?\s*(am|pm)?/i), h && (o = parseInt(h[1], 10), l = parseInt(h[2], 10), c = h[3] ? parseInt(h[3].substr(1), 10) : 0, e = e.substring(0, h.index) + e.substr(h.index + h[0].length), h[4] && (h[4].toLowerCase() == "pm" && 12 > o ? o += 12 : h[4].toLowerCase() != "am" || 12 > o || (o -= 12))), u = function () {
            ...
            return c
        }(), d = [], f = 0; f < u.length; ++f) y = u[f], /^[0-9]{4}$/.test(y) ? (s = parseInt(y, 10), null == i && null == r && null == n && (n = !0)) : /^[0-9]{1,2}$/.test(y) ? (y = parseInt(y, 10), 60 > y ? 0 > y || y > 12 ? 1 > y || y > 31 || (r = y) : d.push(y) : s = y) : null == i && (i = I(y))
        return d.length < 2 ? d.length == 1 && (null == r ? r = d.shift() : null == i && (i = d.shift())) : n ? (null == i && (i = d.shift()), null == r && (r = d.shift())) : (null == r && (r = d.shift()), null == i && (i = d.shift())), null == s && (s = d.length > 0 ? d.shift() : a.getFullYear()), 30 > s ? s += 2e3 : 99 > s && (s += 1900), null == i && (i = a.getMonth() + 1), null != s && null != i && null != r ? new Date(s, i - 1, r, o, l, c) : null
    }, ae = {
