...
function ganttGetDateString(date) {
    return date.getDate().toString() + ' ' + ganttRuMothsArray[date.getMonth()];
}
...
// changed: calculate height by number of tasks in all projects
    ...
    if (this._showTreePanel)
    {
        ...
        this.panelNames.appendChild(this.createPanelNamesTasks());
        this.panelNames.style.cssText = "position:relative;left:0px;top:40px;z-index:5;overflow:hidden;border-left:#f1f3f1 1px solid;border-bottom:#f1f3f1 1px solid;width:310px";
    ...
    divCell.style.cssText = "position: relative; overflow-y:auto; overflow-x:auto;";
